...
class NewsRoute extends StatefulWidget {
  const NewsRoute({Key? key}) : super(key: key);

  @override
  _NewsPageState createState() => _NewsPageState();
}

class _NewsPageState extends State<NewsRoute> {
...
//haber göstericeğimiz alan !!
//nasıl yapıcaz bunu ya sql den mi acaba bilgi
// versek ?
